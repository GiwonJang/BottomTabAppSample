 ...
 */
public class OlderFragment extends BaseFragment {

	// constants
	private static final String TAG = "OlderFragment";
	...
	public static OlderFragment newInstance() {
